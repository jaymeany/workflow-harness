#!/bin/bash
#
# load-dev-standards.sh — Claude Code SessionStart hook
#
# Emits the raw contents of Dev_Standards.md (Implementation Standards
# + Anti-Patterns) via hookSpecificOutput.additionalContext so the doc
# is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Does not
# parse the doc or know its structure. Edit Dev_Standards.md however
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Dev_Standards.md"
