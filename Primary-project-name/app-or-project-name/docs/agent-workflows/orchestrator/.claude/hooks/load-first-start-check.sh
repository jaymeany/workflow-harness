...
banner+="  3. Open the session as it says: what this is, that nothing"$'\n'
banner+="     is locked in, that they can stop any time, and the"$'\n'
banner+="     scale. Give the 30 to 45 minute range, and say it"$'\n'
banner+="     depends on how much you do."$'\n'
