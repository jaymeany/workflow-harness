#!/bin/bash
#
# load-research-protocol.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/Research_Protocol.md via
# hookSpecificOutput.additionalContext so the Research methodology
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Research_Protocol.md"
