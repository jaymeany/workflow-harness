#!/bin/bash
#
# load-research-cards.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/Research_Cards.md via
# hookSpecificOutput.additionalContext so the card-mechanics + hook
# inventory doc is available from turn 1.
#
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Research_Cards.md"
