#!/bin/bash
#
# load-designer-protocol.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/Designer_Protocol.md via hookSpecificOutput.additionalContext so
# the design methodology is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Edit protocol/Designer_Protocol.md however you
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Designer_Protocol.md"
[[ -f "$FILE" ]] || exit 0
