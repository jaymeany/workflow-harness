#!/bin/bash
#
# load-designer-cards.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/Designer_Cards.md via hookSpecificOutput.additionalContext so
# card mechanics and handoff is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Edit protocol/Designer_Cards.md however you
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Designer_Cards.md"
[[ -f "$FILE" ]] || exit 0
