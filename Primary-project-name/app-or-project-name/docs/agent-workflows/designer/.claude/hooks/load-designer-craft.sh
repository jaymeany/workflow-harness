#!/bin/bash
#
# load-designer-craft.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/Designer_Craft.md via hookSpecificOutput.additionalContext so
# the craft bar and the component reach order is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Edit protocol/Designer_Craft.md however you
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/Designer_Craft.md"
[[ -f "$FILE" ]] || exit 0
