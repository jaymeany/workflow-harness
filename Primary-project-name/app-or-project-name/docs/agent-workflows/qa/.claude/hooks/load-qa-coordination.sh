#!/bin/bash
#
# load-qa-coordination.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/QA_Coordination.md via
# hookSpecificOutput.additionalContext so the card naming convention
# and messaging bus mechanics are in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Does not
# parse the doc or know its structure. Edit protocol/QA_Coordination.md
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/QA_Coordination.md"
