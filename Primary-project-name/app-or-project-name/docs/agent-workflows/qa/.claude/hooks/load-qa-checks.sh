#!/bin/bash
#
# load-qa-checks.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/QA_Checks.md via
# hookSpecificOutput.additionalContext so the seven-checks methodology
# is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Does not
# parse the doc or know its structure. Edit protocol/QA_Checks.md
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/QA_Checks.md"
