#!/bin/bash
#
# load-qa-hooks.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/QA_Hooks.md via
...
# parse the doc or know its structure. Edit protocol/QA_Hooks.md
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/QA_Hooks.md"
