#!/bin/bash
#
# load-qa-surface.sh — Claude Code SessionStart hook
#
# Emits the raw contents of protocol/QA_Surface.md via
# hookSpecificOutput.additionalContext so the rendered-surface checks (sections 5 to 7)
# is in context from turn 1.
#
# Dumb file loader: reads the file as-is, emits in full. Does not
# parse the doc or know its structure. Edit protocol/QA_Surface.md
...
FILE="${CLAUDE_PROJECT_DIR}/protocol/QA_Surface.md"
